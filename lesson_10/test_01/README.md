...
2. В отчете Allure вы увидите:
   - **Название теста**: `Проверка заполнения формы`.
   ...
   - **Шаги теста**:
    ...
    - отправка формы;
    - получение класса поля с ID ZIP-кода;
    - gроверка наличия ошибки в поле ZIP-кода;
    - проверка успешного заполнения всех полей
    - проверка успешного заполнения всех полей.

   - **Результат**: ожидаемое наличие ошибки в поле ZIP-кода
